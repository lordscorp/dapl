    ...
    <div id="app">
        ...
        <div class="card w-75 mx-auto mt-4">
            <div class="card-body">
                ...
                <div class="row g-2">
                    ...
                    <div class="col">
                        ...
                        <div class="row g-2" v-for="(item, index) in objProcesso.uniCatUso" :key="index">
                            ...
                            <div class="col">
                                <input type="number" class="form-control" v-model="item.valor" placeholder="Valor">
                            </div>
                        </div>
                ...
                <div class="mt-4 row">
                    <div class="col mx-2" id="txt-aprovacao">
                        <div class="card">
                    ...
                    <div class="col mx-2" id="txt-conclusao">
                        <div class="card">
                ...
                <!-- <div class="row">
                    <div class="col">
                        <table class="table">
                            <tr>
                                <th v-for="(valor, chave) in processos[0]">
                                    @{{ traduzir(chave) }}
                                </th>
                            </tr>
                            <tr v-for="processo in processos">
                                <td v-for="campo in processo">
                                    @{{ campo }}
                                </td>
                            </tr>
                        </table>
